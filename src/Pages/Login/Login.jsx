...
import {
  sendGoogleCredentialToApi,
  getUserFromToken,
} from "../../Services/GoogleService/GoogleService"
    ...
    async function handleSendGoogleCredential() {
      if (googleCredential) {
        try {
          ...
          const response = await sendGoogleCredentialToApi(
    ...
    <div style={{ height: "100vh" }}>
      <div className="container">
        ...
        <form className="w-75 mt-5 mx-auto" onSubmit={""}>
          ...
          {/*  Create account*/}
          {/*</Link>*/}
          <span className="text-white fw-normal ms-5">
            <Trans id="login.info">
              Please, for this time use only Google login
            </Trans>
          </span>
